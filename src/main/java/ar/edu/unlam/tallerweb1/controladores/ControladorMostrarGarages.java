...
public class ControladorMostrarGarages {
	...
	private ServicioRegistro servicioRegsitro;
	@Autowired
	public ControladorMostrarGarages(ServicioGarage servicioGarage,ServicioRegistro servicioRegsitro ){
		this.servicioGarage = servicioGarage;
		this.servicioRegsitro = servicioRegsitro ;
	...
	*/
	...
	public ModelAndView agregarAutoAGarage( @PathVariable("id")Long id,
		...
		ModelMap modelo = new ModelMap();
		List<Garage> listaGarage = servicioGarage.consultarGarage();
		List<Auto> listaAuto = servicioRegsitro.consultarListaAutosRegistrados();
